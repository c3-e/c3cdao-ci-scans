...
the v0.6 inputs (the original 7, plus publish_images added for the
digest-verified quarantine publish mechanism) + 4 secrets, image-scan
fans out over the plan matrix
